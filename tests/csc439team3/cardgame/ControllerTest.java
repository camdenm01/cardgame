...
public class ControllerTest {
    ...
    @Test
    void getPlayers(){
        controller = new Controller(new TestView(2,1,1,1));
    ...
    void playerDrawsFromPile() throws Exception {
        controller = new Controller(new TestView(1, 1, 1,1));
        controller.getPlayers();
        controller.dealHand();
    ...
    void playerDrawsFromPileThenDiscards() throws Exception{
        controller = new Controller(new TestView(1, 1, 0,1));
        controller.getPlayers();
        controller.dealHand();
    ...
    void playerDrawsFromDiscard() throws Exception {
        controller = new Controller(new TestView(1, 2, 1,1));
        controller.getPlayers();
        controller.dealHand();
